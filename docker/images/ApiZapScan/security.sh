...
cat zap.out
zap-cli --zap-url http://0.0.0.0 -p 80 report -o /zap/api-report.html -f html
cp /zap/api-report.html /zap/wrk/
curl --fail http://0.0.0.0:80/OTHER/core/other/jsonreport/?formMethod=GET --output report.json
cp *.* /zap/wrk/
