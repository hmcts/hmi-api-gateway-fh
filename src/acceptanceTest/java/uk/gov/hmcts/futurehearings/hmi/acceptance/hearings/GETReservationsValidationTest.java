...
public class GETReservationsValidationTest extends HearingValidationTest {
    ...
    @ParameterizedTest(name = "Testing valid and invalid values of the query parameter - requestStartDate "
            + ": {0} --> {1}")
    @CsvSource(value = {"requestStartDate,2018-01-29 20:36:01Z", "requestStartDate,AD12H", "requestStartDate,''",
            "requestStartDate,' '", "requestStartDate,NIL"}, nullValues = "NIL")
    void test_request_start_date_query_param(final String requestStartDateKey, final String requestStartDateValue)
            throws Exception {
    ...
    @CsvSource(value = {"requestEndDate, 2018-01-29 20:36:01Z", "requestEndDate, AD12H", "requestEndDate, ''",
            "requestEndDate, ' '", "requestEndDate, NIL"}, nullValues = "NIL")
    void test_request_end_date_query_param(final String requestEndDateKey, final String requestEndDateValue)
            throws Exception {
        this.setUrlParams(buildQueryParams(requestEndDateKey, requestEndDateValue));
        test_response_for_supplied_parameter();
    }

    @ParameterizedTest(name = "Testing valid and invalid values of the query parameter - requestDuration : "
            + "{0} --> {1}")
    ...
    void test_request_duration_query_param(final String requestDurationKey, final String requestDurationValue)
            throws Exception {
        this.setUrlParams(buildQueryParams(requestDurationKey, requestDurationValue));
        test_response_for_supplied_parameter();
    }

    @ParameterizedTest(name = "Testing valid and invalid values of the query parameters - requestLocationType, "
            + "requestLocationId and requestLocationReferenceType - Param : {0} --> {1}")
    @CsvSource({"requestLocationType, Court, requestLocationId, 300, requestLocationReferenceType, EXTERNAL",
            "requestLocationType, ADHOC, requestLocationId, Unknown, requestLocationReferenceType, Undefined"})
    ...
    @ParameterizedTest(name = "Testing valid and invalid values of the query parameter - requestComments : "
            + "{0} --> {1}")
    ...
    void test_request_Comments_query_param(final String requestCommentsKey, final String requestCommentsValue)
            throws Exception {
        this.setUrlParams(buildQueryParams(requestCommentsKey, requestCommentsValue));
        test_response_for_supplied_parameter();
    }

    @ParameterizedTest(name = "Testing valid and invalid values of the query parameter - requestExternalId : "
            + "{0} --> {1}")
    @CsvSource(value = {"requestExternalId, TEST_EXTERNAL_ID", "requestExternalId, ADHOC", "requestExternalId, "
            + "''", "requestExternalId, ' '", "requestExternalId, NIL"}, nullValues = "NIL")
    void test_request_external_id_query_param(final String requestExternalIdKey, final String requestExternalIdValue)
            throws Exception {
