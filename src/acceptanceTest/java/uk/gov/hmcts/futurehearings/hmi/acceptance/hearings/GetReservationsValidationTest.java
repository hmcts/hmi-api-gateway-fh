...
public class GetReservationsValidationTest extends HearingValidationTest {
    ...
    @ParameterizedTest(name = "Testing valid and invalid values of the query parameter - "
            + "requestStartDate : {0} --> {1}")
    ...
    void test_request_start_date_query_param(final String requestStartDateKey,
    ...
    void test_request_end_date_query_param(final String requestEndDateKey,
    ...
    void test_request_duration_query_param(final String requestDurationKey,
    ...
    @ParameterizedTest(name = "Testing valid and invalid values of the query parameters - "
    ...
    void test_request_Comments_query_param(final String requestCommentsKey,
    ...
    void test_request_external_id_query_param(final String requestExternalIdKey,
