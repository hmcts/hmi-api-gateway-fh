...
import static uk.gov.hmcts.futurehearings.hmi.contract.consumer.common.RestDelegate.invokeAPIWithQueryParameters;
...
public class GetHearingsQueriedByUsernameAPIConsumerTest extends ContractTest {
    ...
    void shouldGetCompleteHearingsResponse(MockServer mockServer)
        ...
        Response response = invokeAPIWithQueryParameters(headersAsMap,
