...
public class HmiApiUnitTest {
    ...
    /*@Test
    @DisplayName("Unit Test to Test request body validation for field 'Case Id'")
    ...
    @Test
    @DisplayName("Unit Test to Test request body validation for field 'Venue'")
    public void testRequestVAlidation() {
    ...
    @Test
    @DisplayName("Unit Test to Test request body validation for field 'Jurisdiction'")
    public void testRequestVAlidation() {
    ...
    @Test
    @DisplayName("Unit Test to Test request body validation for field 'Service'")
    public void testRequestVAlidation() {
    ...
    @Test
    @DisplayName("Unit Test to Test request body validation for field 'Case Type'")
    public void testRequestVAlidation() {
    ...
    @Test
    @DisplayName("Unit Test to Test request body validation for field 'Hearing Type'")
    public void testRequestVAlidation() {
    ...
    @Test
    @DisplayName("Unit Test to Test request body validation for field 'Hearing channel'")
    public void testRequestVAlidation() {
    ...
    @Test
    @DisplayName("Unit Test to Test request body validation for field 'Private Hearing'")
    public void testRequestVAlidation() {
    ...
    @Test
    @DisplayName("Unit Test to Test request body validation for field 'Allocated Listing Team'")
    public void testRequestVAlidation() {
