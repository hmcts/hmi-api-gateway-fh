...
class DeleteResourcesUnitTests {
    ...
    void testDeleteResourcesRequestForInvalidResource() throws IOException {
        ...
        final Response response = httpClient.httpDelete(resourcesApiRootContext + "delete",
    ...
    private Response deleteResourceById(final String input) {
        return httpClient.httpDelete(resourcesApiRootContext + "/resource123",
                headersAsMap, paramsAsMap, input);
    }

    private Response deleteResourceByIdNoAuth(final String input) {
        return httpClient.httpDeleteNoAuth(resourcesApiRootContext + "/resource123",
                headersAsMap, paramsAsMap, input);
    }
