...
@DisplayName("DELETE /hearings/{hearingId}/joh/{personalCode} - Delete Judicial Office Holder details")
@SuppressWarnings({"java:S2699", "PMD.TooManyMethods"})
class DeleteVideoHearingsJohUnitTests {

    @Value("${targetInstance}")
    private String targetInstance;

    @Value("${joh_idVideoHearingRootContext}")
    private String deleteJohApiRootContext;
    ...
    void testDeleteVideoHearingsJohForValidHeaders() {
    ...
    void testDeleteVideoHearingsJohRequestWithMissingContentTypeHeader() {
    ...
    void testDeleteVideoHearingsJohRequestWithInvalidContentTypeHeader() {
        headersAsMap.remove(CONTENT_TYPE);
    ...
    void testDeleteVideoHearingsJohRequestWithMissingAcceptHeader() {
    ...
    void testDeleteVideoHearingsJohRequestWithInvalidAcceptHeader() {
        headersAsMap.remove(ACCEPT);
    ...
    void testDeleteVideoHearingsJohRequestWithMissingAccessToken() {
    ...
    void testDeleteVideoHearingsJohRequestWithInvalidAccessToken() {
    ...
    private Response whenDeleteVideoHearingIsInvoked() {
        return sendDeleteRequestForVideoHearing(String.format(deleteJohApiRootContext, ID, ID),
                headersAsMap, targetInstance);
    }

    private Response whenDeleteHearingsRequestIsInvokedWithMissingOrInvalidHeader() {
        return deleteHearingsResponseForMissingOrInvalidHeader(
                String.format(deleteJohApiRootContext, ID, ID), headersAsMap, targetInstance);
    }

    private Response whenDeleteHearingsRequestIsInvokedWithMissingAccessToken() {
        return deleteHearingsResponseForMissingAccessToken(String.format(deleteJohApiRootContext, ID, ID),
                headersAsMap, targetInstance);
    }
