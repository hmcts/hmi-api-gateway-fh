...
class GetSchedulesUnitTests {
    ...
    private Response whenRetrieveHearingScheduleIsInvokedForInvalidResource() {
        return retrieveHearingSchedulesResponseForInvalidResource(schedulesApiRootContext + "get",
                headersAsMap, targetInstance);
    }

    private Response whenRetrieveHearingScheduleIsInvokedWithCorrectHeadersAndNoParams() {
        return retrieveHearingSchedulesResponseForCorrectRequestAndNoParams(schedulesApiRootContext,
                headersAsMap, targetInstance);
    }

    private Response whenRetrieveHearingScheduleIsInvokedWithCorrectHeadersAndAllParams() {
        return retrieveHearingSchedulesResponseForCorrectRequestAndAllParams(schedulesApiRootContext,
                headersAsMap, paramsAsMap, targetInstance);
    }

    private Response whenRetrieveHearingSchedulesIsInvokedWithMissingAccessToken() {
        return retrieveHearingSchedulesResponseForMissingAccessToken(schedulesApiRootContext,
                headersAsMap, paramsAsMap, targetInstance);
    }

    private Response whenRetrieveHearingSchedulesIsInvokedWithMissingOrInvalidHeader() {
        return retrieveHearingSchedulesResponseForMissingOrInvalidHeader(schedulesApiRootContext,
                headersAsMap, paramsAsMap, targetInstance);
    }


    private Response retrieveHearingSchedulesResponseForInvalidResource(final String api,
    ...
    private Response retrieveHearingSchedulesResponseForCorrectRequestAndNoParams(final String api,
        final Map<String, Object> headersAsMap, final String basePath) {
    ...
    private Response retrieveHearingSchedulesResponseForCorrectRequestAndAllParams(final String api,
    ...
    private Response retrieveHearingSchedulesResponseForMissingAccessToken(final String api,
        final Map<String, Object> headersAsMap, final Map<String, String> paramsAsMap, final String basePath) {
    ...
    private Response retrieveHearingSchedulesResponseForMissingOrInvalidHeader(final String api,
        final Map<String, Object> headersAsMap, final Map<String, String> paramsAsMap, final String basePath) {
