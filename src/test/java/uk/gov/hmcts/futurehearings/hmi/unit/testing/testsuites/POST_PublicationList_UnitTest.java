...
@DisplayName("POST /publication/list - Create PublicationList")
public class POST_PublicationList_UnitTest {

    private static final String CORRECT_PUBLICATION_LIST_PAYLOAD = "requests/create-publication-list-payload.json";
    ...
    void setToken(){
        ...
        publicationCtx = String.format(genericPublicationApiRootContext, "list");
    }
    ...
    void testCreatePublicationListForInvalidResource() throws IOException {
        final String input = givenAPayload(CORRECT_PUBLICATION_LIST_PAYLOAD);
    ...
    void testCreatePublicationListWithMissingContentTypeHeader() throws IOException {
    ...
    void testCreatePublicationListWithInvalidContentTypeHeader() throws IOException {
        headersAsMap.remove("Content-Type");
    ...
    void testCreatePublicationListWithMissingAcceptHeader() throws IOException {
    ...
    void testCreatePublicationListWithInvalidAcceptHeader() throws IOException {
        headersAsMap.remove("Accept");
    ...
    void testCreatePublicationListWithMissingHeader(String iteration) throws IOException {
    ...
    @ValueSource(strings = {"Source-System","Destination-System","Request-Created-At"})
    void testCreatePublicationListWithInvalidHeader(String iteration) throws IOException {
        headersAsMap.remove(iteration);
    ...
    void testCreatePublicationListWithCorrectHeaders() throws IOException {
        final String input = givenAPayload(CORRECT_PUBLICATION_LIST_PAYLOAD);
        final Response response = createResource(input);
    ...
    void testCreatePublicationListWithMissingAccessToken() throws IOException {
        final String input = givenAPayload(CORRECT_PUBLICATION_LIST_PAYLOAD);
    ...
    void testCreatePublicationListWithInvalidAccessToken() throws IOException {
