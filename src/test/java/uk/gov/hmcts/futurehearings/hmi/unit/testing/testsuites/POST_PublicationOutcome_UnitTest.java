...
@DisplayName("POST /publication/outcome - Create PublicationOutcome")
public class POST_PublicationOutcome_UnitTest {

    private static final String CORRECT_PUBLICATION_OUTCOME_PAYLOAD = "requests/create-publication-outcome-payload.json";
    ...
    void setToken(){
        ...
        publicationCtx = String.format(genericPublicationApiRootContext, "outcome");
    }
    ...
    void testCreatePublicationOutcomeForInvalidResource() throws IOException {
        final String input = givenAPayload(CORRECT_PUBLICATION_OUTCOME_PAYLOAD);
    ...
    void testCreatePublicationOutcomeWithMissingContentTypeHeader() throws IOException {
    ...
    void testCreatePublicationOutcomeWithInvalidContentTypeHeader() throws IOException {
        headersAsMap.remove("Content-Type");
    ...
    void testCreatePublicationOutcomeWithMissingAcceptHeader() throws IOException {
    ...
    void testCreatePublicationOutcomeWithInvalidAcceptHeader() throws IOException {
        headersAsMap.remove("Accept");
    ...
    void testCreatePublicationOutcomeWithMissingHeader(String iteration) throws IOException {
    ...
    @ValueSource(strings = {"Source-System","Destination-System","Request-Created-At"})
    void testCreatePublicationOutcomeWithInvalidHeader(String iteration) throws IOException {
        headersAsMap.remove(iteration);
    ...
    void testCreatePublicationOutcomeWithCorrectHeaders() throws IOException {
        final String input = givenAPayload(CORRECT_PUBLICATION_OUTCOME_PAYLOAD);
        final Response response = createResource(input);
    ...
    void testCreatePublicationOutcomeWithMissingAccessToken() throws IOException {
        final String input = givenAPayload(CORRECT_PUBLICATION_OUTCOME_PAYLOAD);
    ...
    void testCreatePublicationOutcomeWithInvalidAccessToken() throws IOException {
