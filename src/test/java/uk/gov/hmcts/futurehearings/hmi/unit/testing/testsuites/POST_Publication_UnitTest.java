...
@DisplayName("POST /publication/publication - Create Publication")
public class POST_Publication_UnitTest {

    private static final String CORRECT_PUBLICATION_PAYLOAD = "requests/create-publication-payload.json";
    ...
    void testCreatePublicationForInvalidResource() throws IOException {
        final String input = givenAPayload(CORRECT_PUBLICATION_PAYLOAD);
    ...
    void testCreatePublicationWithMissingContentTypeHeader() throws IOException {
    ...
    void testCreatePublicationWithInvalidContentTypeHeader() throws IOException {
        headersAsMap.remove("Content-Type");
    ...
    void testCreatePublicationWithMissingAcceptHeader() throws IOException {
    ...
    void testCreatePublicationWithInvalidAcceptHeader() throws IOException {
        headersAsMap.remove("Accept");
    ...
    void testCreatePublicationWithMissingHeader(String iteration) throws IOException {
    ...
    @ValueSource(strings = {"Source-System","Destination-System","Request-Created-At"})
    void testCreatePublicationWithInvalidHeader(String iteration) throws IOException {
        headersAsMap.remove(iteration);
    ...
    void testCreatePublicationWithCorrectHeaders() throws IOException {
        final String input = givenAPayload(CORRECT_PUBLICATION_PAYLOAD);
        final Response response = createResource(input);
    ...
    void testCreatePublicationWithMissingAccessToken() throws IOException {
        final String input = givenAPayload(CORRECT_PUBLICATION_PAYLOAD);
    ...
    void testCreatePublicationWithInvalidAccessToken() throws IOException {
