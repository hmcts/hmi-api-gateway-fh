...
public class PutResourcesLinkedHearingGrpUnitTests {
    ...
    private Response whenUpdateLinkedHearingGroupResourceIsInvokedWithMissingOrInvalidHeader(final String input) {
        return updateLinkedHearingGroupResourceResponseForAMissingOrInvalidHeader(linkedHearingGroupCtx,
    ...
    private Response whenUpdateLinkedHearingGroupResourceIsInvokedWithMissingAccessToken(final String input) {
        return updateLinkedHearingGroupResourceResponseForMissingAccessToken(linkedHearingGroupCtx,
                headersAsMap, targetInstance, input);
    }

    private Response whenUpdateLinkedHearingGroupResourceIsInvokedForInvalidResource(final String input) {
        return updateLinkedHearingGroupResourceResponseForInvalidResource(linkedHearingGroupCtx + "/put",
                headersAsMap, targetInstance, input);
    }

    private Response whenUpdateLinkedHearingGroupResourceIsInvokedWithCorrectHeaders(final String input) {
        return updateLinkedHearingGroupResourceResponseForCorrectHeadersAndParams(linkedHearingGroupCtx,
                headersAsMap, targetInstance, input);
    }

    private Response updateLinkedHearingGroupResourceResponseForInvalidResource(final String api,
    ...
    private Response updateLinkedHearingGroupResourceResponseForCorrectHeadersAndParams(final String api,
        final Map<String, Object> headersAsMap, final String basePath, final String payloadBody) {
    ...
    private Response updateLinkedHearingGroupResourceResponseForAMissingOrInvalidHeader(final String api,
        final Map<String, Object> headersAsMap, final String basePath, final String payloadBody) {
    ...
    private Response updateLinkedHearingGroupResourceResponseForMissingAccessToken(final String api,
        final Map<String, Object> headersAsMap, final String basePath, final String payloadBody) {
