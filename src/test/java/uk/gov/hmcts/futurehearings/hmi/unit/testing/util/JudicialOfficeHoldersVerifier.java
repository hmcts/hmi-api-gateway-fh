...
public final class JudicialOfficeHoldersVerifier {
    ...
    public static void thenValidateResponseForAddJoh(final Response response) {
        try {
    ...
    public static void thenValidateResponseForAddJohWithInvalidHeader(Response response) {
        try {
    ...
    public static void thenValidateResponseForAddJohWithInvalidToken(final Response response) {
        try {
    ...
    private JudicialOfficeHoldersVerifier() {
    }
}
